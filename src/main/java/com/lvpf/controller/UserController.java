...
public class UserController {
	...
	public String save(){
		...
		userDao.save(new User(null,null,null,null));
		return "success";
	}
	...
	public void hello(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
